...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View correctDialogView = factory.inflate(R.layout.custom_dialog, null);
        final AlertDialog correctDialog = new AlertDialog.Builder(this).create();
        correctDialog.setView(correctDialogView);
        TextView tv1 = (TextView) correctDialogView.findViewById(R.id.custom_text_1);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
              /*  if (!MyApp.getInstance().regionList.isEmpty()) {
                ...
                String beaconSSN = MyApp.getInstance().regionList.get(i).getId2().toHexString();
                String rn = MyApp.getInstance().regionNameList.get(i);
                if(rn.equals("Ruby Room")){

                    Intent intent = new Intent(MainActivity.this , FullDescription.class);
                    Bundle extras = new Bundle();
                    extras.putString("Title" , String.valueOf(R.string.titleRuby));
                    extras.putString("Desc" , String.valueOf(R.string.DescRuby));
                ...
                if(rn.equals("Office")){
                    ...
                    Intent intent = new Intent(MainActivity.this , FullDescription.class);
                    Bundle extras = new Bundle();
                    extras.putString("Title" , String.valueOf(R.string.titleOffice));
                    extras.putString("Desc" , String.valueOf(R.string.DescOffice));
                    intent.putExtras(extras);
                    startActivity(intent);

                }
                if(rn.equals("Python Room")){
                ...
                if(rn.equals("iOS Room")){

                    Intent intent = new Intent(MainActivity.this , FullDescription.class);
                    Bundle extras = new Bundle();
                    extras.putString("Title" , String.valueOf(R.string.titleIos));
                    extras.putString("Desc" , String.valueOf(R.string.DescIos));
                    intent.putExtras(extras);
                    startActivity(intent);

                }
                if(rn.equals("Android Room")){

                    Intent intent = new Intent(MainActivity.this , FullDescription.class);
                    Bundle extras = new Bundle();
                    extras.putString("Title" , String.valueOf(R.string.titleAndroid));
                    extras.putString("Desc" , String.valueOf(R.string.DescAndroid));
                    intent.putExtras(extras);
                    startActivity(intent);

                }
                if(rn.equals("Git Room")){

                    Intent intent = new Intent(MainActivity.this , FullDescription.class);
                    Bundle extras = new Bundle();
                    extras.putString("Title" , String.valueOf(R.string.titleGit));
                    extras.putString("Desc" , String.valueOf(R.string.DescGit));
                    intent.putExtras(extras);
                    startActivity(intent);
